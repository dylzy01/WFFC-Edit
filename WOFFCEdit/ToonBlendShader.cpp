...
Microsoft::WRL::ComPtr<ID3D11VertexShader>	ToonBlendShader::m_shaderVertex;
Microsoft::WRL::ComPtr<ID3D11PixelShader>	ToonBlendShader::m_shaderPixel;
ID3D11InputLayout *							ToonBlendShader::m_inputLayout;
ID3D11Buffer *								ToonBlendShader::m_bufferMatrix;
ID3D11SamplerState *						ToonBlendShader::m_samplerState;
ID3D11Buffer *								ToonBlendShader::m_bufferLight;
DirectX::SimpleMath::Matrix *				ToonBlendShader::m_world;
DirectX::SimpleMath::Matrix *				ToonBlendShader::m_view;
DirectX::SimpleMath::Matrix *				ToonBlendShader::m_projection;

// Load vertex & pixel shaders
bool ToonBlendShader::Initialise(ID3D11Device * device)
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load shader : Vertex
	auto vertexShaderBuffer = DX::ReadData(L"toon_blend_vs.cso");
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load shader : Pixel
	auto pixelShaderBuffer = DX::ReadData(L"toon_blend_ps.cso");
...
// Setup shader 
bool ToonBlendShader::SetShaderParameters(ID3D11DeviceContext * context, ID3D11ShaderResourceView* texture1, ID3D11ShaderResourceView* texture2, std::vector<Light*> light)
{
...
// Handler
void ToonBlendShader::Enable(ID3D11DeviceContext * context)
{
