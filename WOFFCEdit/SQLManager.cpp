...
sqlite3 *SQLManager::m_databaseConnection;
sqlite3_stmt *SQLManager::m_resultObject, *SQLManager::m_resultChunk;

// Send query to database
bool SQLManager::SendQuery(char * query, bool isObject)
{
	// Controller
	int rc = -1;
...
SceneObject SQLManager::CreateObject()
{
	// Setup temp object
	SceneObject object;
...
ChunkObject SQLManager::CreateChunk()
{
...
bool SQLManager::AddObject(SceneObject object)
{
	// Controller
	int rc = -1;
...
bool SQLManager::RemoveObject(SceneObject object)
{
	// Controller
	int rc = -1;
...
bool SQLManager::SaveObjects(std::vector<SceneObject> sceneGraph)
{
	// Controller
	int rc = -1;
