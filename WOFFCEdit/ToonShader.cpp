...
Microsoft::WRL::ComPtr<ID3D11VertexShader>	ToonShader::m_shaderVertex;
Microsoft::WRL::ComPtr<ID3D11PixelShader>	ToonShader::m_shaderPixel;
ID3D11InputLayout *							ToonShader::m_inputLayout;
...
bool ToonShader::Initialise(ID3D11Device * device)
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load shader : Vertex
	auto vertexShaderBuffer = DX::ReadData(L"toon_vs.cso");
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load shader : Pixel
	auto pixelShaderBuffer = DX::ReadData(L"toon_ps.cso");
...
// Setup shader 
bool ToonShader::SetShaderParameters(bool isNormal, ID3D11DeviceContext * context, ID3D11ShaderResourceView* texture1, std::vector<DisplayObject> lights)
{
...
// Handler
void ToonShader::Enable(ID3D11DeviceContext * context)
{
