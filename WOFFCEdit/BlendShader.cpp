...
Microsoft::WRL::ComPtr<ID3D11VertexShader>	BlendShader::m_shaderVertex;
Microsoft::WRL::ComPtr<ID3D11PixelShader>	BlendShader::m_shaderPixel;
ID3D11InputLayout *							BlendShader::m_inputLayout;
...
bool BlendShader::Initialise(ID3D11Device * device)
{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load shader : Vertex
	auto vertexShaderBuffer = DX::ReadData(L"blend_vs.cso");
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Load shader : Pixel
	auto pixelShaderBuffer = DX::ReadData(L"blend_ps.cso");
...
// Handler
void BlendShader::Enable(ID3D11DeviceContext * context)
{
